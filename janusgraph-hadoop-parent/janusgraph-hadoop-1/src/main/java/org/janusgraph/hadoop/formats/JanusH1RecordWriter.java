...
public class JanusH1RecordWriter extends RecordWriter<NullWritable, VertexWritable> {

    private static final Logger log = LoggerFactory.getLogger(JanusH1RecordWriter.class);

    private final TaskAttemptContext taskAttemptContext;
    private final StandardJanusTx tx;
    private final Set<String> persistableKeys;

    public JanusH1RecordWriter(TaskAttemptContext taskAttemptContext, StandardJanusTx tx, Set<String> persistableKeys) {
    ...
    public void close(TaskAttemptContext context) throws IOException, InterruptedException {
        // commit/rollback happens in JanusOutputCommitter
        // nothing to do here
    }
}
