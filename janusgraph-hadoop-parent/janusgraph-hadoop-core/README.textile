...
* Support for various graph-based data sources/sinks
  ** "Janus":http://thinkaurelius.github.com/janus/ distributed graph database
  ...
  ** User defined import/export "scripts":https://github.com/JanusGraph/faunus/wiki/Script-Format
...
Read the "Faunus documentation":https://github.com/JanusGraph/faunus/wiki and join the "mailing list":https://groups.google.com/forum/#!forum/aureliusgraphs.
