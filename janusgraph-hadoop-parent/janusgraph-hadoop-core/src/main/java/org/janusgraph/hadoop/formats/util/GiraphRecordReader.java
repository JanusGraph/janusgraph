...
public class GiraphRecordReader extends RecordReader<NullWritable, VertexWritable> {
    ...
    private JanusVertexDeserializer deser;
    private VertexWritable vertex;

    public GiraphRecordReader(final GiraphInputFormat.RefCountedCloseable<JanusVertexDeserializer> countedDeser,
    ...
    public boolean nextKeyValue() throws IOException, InterruptedException {
        while (reader.nextKeyValue()) {
            // TODO janus05 integration -- the duplicate() call may be unnecessary
