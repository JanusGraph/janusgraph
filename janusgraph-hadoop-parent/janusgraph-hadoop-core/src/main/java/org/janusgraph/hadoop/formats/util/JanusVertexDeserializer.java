...
public class JanusVertexDeserializer implements AutoCloseable {
    ...
    private static final Logger log =
            LoggerFactory.getLogger(JanusVertexDeserializer.class);

    public JanusVertexDeserializer(final JanusHadoopSetup setup) {
        this.setup = setup;
...
//                        }
//                    }
//                    for (JanusRelation rel : frel.query().queryAll().relations())
