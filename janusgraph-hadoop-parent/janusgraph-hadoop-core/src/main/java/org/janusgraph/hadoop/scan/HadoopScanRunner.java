...
public class HadoopScanRunner {
     ...
     *        that reads (row, columns) pairs out of a Janus edgestore
    ...
    public static ScanMetrics runJob(Configuration conf, String confRootField,
        ...
        if (null != confRootField) {
            ...
            scanConf.set(JanusHadoopConfiguration.SCAN_JOB_CONFIG_ROOT, confRootField);
            ...
            ModifiableConfiguration hadoopJobConf = ModifiableHadoopConfiguration.prefixView(confRoot,
                    JanusHadoopConfiguration.SCAN_JOB_CONFIG_KEYS, scanConf);

            // Copy scanjob settings from the Janus Configuration instance to the Hadoop Configuration instance
    ...
    public static ScanMetrics runScanJob(ScanJob scanJob, Configuration conf, String confRootField,
        ...
        scanConf.set(JanusHadoopConfiguration.SCAN_JOB_CLASS, scanJob.getClass().getName());
    ...
    public static ScanMetrics runVertexScanJob(VertexScanJob vertexScanJob, Configuration conf, String confRootField,
        ...
        scanConf.set(JanusHadoopConfiguration.SCAN_JOB_CLASS, vertexScanJob.getClass().getName());
