 ...
 * IncompatibleClassChanges in Hadoop core. In theory, janus-hadoop-core should
 ...
 * janus-hadoop-core uses additional Hadoop features, or as bugs are discovered.
 * It's possible to write and use a third-party implementation, but be prepared
 * to update it when upgrading to a newer Janus release.
 */
