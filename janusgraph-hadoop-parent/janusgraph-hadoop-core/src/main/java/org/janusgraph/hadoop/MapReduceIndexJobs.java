...
public class MapReduceIndexJobs {
    ...
    public static ScanMetrics cassandraRepair(String janusPropertiesPath, String indexName, String relationType, String partitionerName)
            throws InterruptedException, IOException, ClassNotFoundException {
        Properties p = new Properties();
        FileInputStream fis = null;
        try {
            fis = new FileInputStream(janusPropertiesPath);
            p.load(fis);
    ...
    public static ScanMetrics cassandraRepair(Properties janusProperties, String indexName, String relationType,
                                              String partitionerName)
            throws InterruptedException, IOException, ClassNotFoundException {
        return cassandraRepair(janusProperties, indexName, relationType, partitionerName, new Configuration());
    }
    ...
    public static ScanMetrics cassandraRepair(Properties janusProperties, String indexName, String relationType,
        ...
        copyPropertiesToInputAndOutputConf(hadoopBaseConf, janusProperties);
    ...
    public static ScanMetrics cassandraRemove(String janusPropertiesPath, String indexName, String relationType, String partitionerName)
            throws InterruptedException, IOException, ClassNotFoundException {
        Properties p = new Properties();
        FileInputStream fis = null;
        try {
    ...
    public static ScanMetrics cassandraRemove(Properties janusProperties, String indexName, String relationType,
                                              String partitionerName)
            throws InterruptedException, IOException, ClassNotFoundException {
        return cassandraRemove(janusProperties, indexName, relationType, partitionerName, new Configuration());
    }
    ...
    public static ScanMetrics hbaseRepair(String janusPropertiesPath, String indexName, String relationType)
            throws InterruptedException, IOException, ClassNotFoundException {
        Properties p = new Properties();
        FileInputStream fis = null;
        try {
    ...
    public static ScanMetrics hbaseRepair(Properties janusProperties, String indexName, String relationType)
            throws InterruptedException, IOException, ClassNotFoundException {
        return hbaseRepair(janusProperties, indexName, relationType, new Configuration());
    }
    ...
    public static ScanMetrics hbaseRemove(String janusPropertiesPath, String indexName, String relationType)
            throws InterruptedException, IOException, ClassNotFoundException {
        Properties p = new Properties();
        FileInputStream fis = null;
        try {
    ...
    public static ScanMetrics hbaseRemove(Properties janusProperties, String indexName, String relationType)
            throws InterruptedException, IOException, ClassNotFoundException {
        return hbaseRemove(janusProperties, indexName, relationType, new Configuration());
    }
    ...
    private static void copyPropertiesToInputAndOutputConf(Configuration sink, Properties source) {
        final String prefix = ConfigElement.getPath(JanusHadoopConfiguration.GRAPH_CONFIG_KEYS, true) + ".";
