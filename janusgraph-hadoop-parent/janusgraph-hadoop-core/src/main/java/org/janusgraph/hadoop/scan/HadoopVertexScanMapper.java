...
public class HadoopVertexScanMapper extends HadoopScanMapper {
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        ...
        ModifiableConfiguration graphConf = getJanusConfiguration(context);
        JanusGraph graph = JanusFactory.open(graphConf);
    ...
    private VertexScanJob getVertexScanJob(ModifiableHadoopConfiguration conf) {
        String jobClass = conf.get(JanusHadoopConfiguration.SCAN_JOB_CLASS);
