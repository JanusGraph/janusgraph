...
* Isolated @FaunusElement@ serializer into @FaunusSerializer@
* All @FaunusVertex@ and @FaunusEdge@ construction via @Configuration@
* Removed @pathEnabled@ boolean from element serialization (now part of @Configuration@)
* Added state tracking for loaded, new, and deleted elements/properties
