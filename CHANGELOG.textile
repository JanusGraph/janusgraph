...
h3. Version 0.4.1 (October 25, 2013)
...
* Improvements to the internal memory structures and algorithms of a Titan transaction which lead to much improved traversal times
...
* Added support for scaling the IDAuthority to hundreds of parallel Titan instances

*Bugfixes:*

* Fixed multiQuery() for specific has() conditions. Added support for multiQuery(Collection).
* Fixed limit adjustment issue for unconstrainted IN/OUT queries
