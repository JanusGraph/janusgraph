...
public class CassandraMapReduceIndexJobsUtils {
    ...
    private static ScanMetrics executeScanRunner(Properties janusgraphProperties, String indexName, String relationType, String partitionerName, Configuration hadoopBaseConf, CassandraHadoopScanRunner cr) throws InterruptedException, IOException, ClassNotFoundException {
