...
public class AstyanaxStorageManager extends AbstractCassandraStoreManager {
    ...
    Map<String,AstyanaxOrderedKeyColumnValueStore> openStores;
    ...
    @Override
    public void mutateMany(Map<String, Map<ByteBuffer, Mutation>> batch, StoreTransactionHandle txh) throws StorageException {
        MutationBatch m = keyspaceContext.getEntity().prepareMutationBatch()
                .setConsistencyLevel(AstyanaxOrderedKeyColumnValueStore.getConsistencyLevel(
                        AstyanaxOrderedKeyColumnValueStore.getTx(txh).getWriteConsistencyLevel()))
