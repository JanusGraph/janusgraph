...
public class InlineBinaryTitanEdge extends SimpleBinaryTitanEdge implements InlineRelation {

	public InlineBinaryTitanEdge(TitanLabel type, InternalTitanVertex start,
	...
	public InlineRelation clone() {
		return new InlineBinaryTitanEdge(getTitanLabel(), getVertex(0), getVertex(1));
	}
