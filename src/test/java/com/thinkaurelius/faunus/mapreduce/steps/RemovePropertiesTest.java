...
import com.thinkaurelius.faunus.mapreduce.steps.RemoveProperties;
...
public class RemovePropertiesTest extends TestCase {
    ...
    public void testMap1() throws IOException {
        ...
        assertEquals(mapDriver.getCounters().findCounter(RemoveProperties.Counters.PROPERTIES_REMOVED).getValue(), 1);
    }
