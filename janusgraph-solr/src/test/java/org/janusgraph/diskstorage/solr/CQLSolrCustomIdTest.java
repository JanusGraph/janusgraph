...
@Testcontainers
public class CQLSolrCustomIdTest extends JanusGraphCustomIdIndexTest {
    ...
    protected ModifiableConfiguration getModifiableConfiguration() {
        ModifiableConfiguration cqlConfig = cassandraContainer.getConfiguration(CQLSolrCustomIdTest.class.getName());
        return solrContainer.getLocalSolrTestConfig(cqlConfig, getIndexBackends());
    }
}
