...
public class HBaseAdmin0_94 implements AdminMask
{

    private static final Logger log = LoggerFactory.getLogger(HBaseAdmin0_94.class);

    private final HBaseAdmin adm;

    public HBaseAdmin0_94(HBaseAdmin adm)
    {
        this.adm = adm;
    }
