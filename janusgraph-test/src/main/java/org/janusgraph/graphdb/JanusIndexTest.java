...
import org.janusgraph.core.JanusIndexQuery;
 ...
 */
public abstract class JanusIndexTest extends JanusGraphBaseTest {
    ...
    private static final Logger log =
            LoggerFactory.getLogger(JanusIndexTest.class);

    protected JanusIndexTest(boolean supportsGeoPoint, boolean supportsNumeric, boolean supportsText) {
     ...
     * method used as the standard example that ships with Janus.
     */
    @Test
    ...
    public static void assertGraphOfTheGods(JanusGraph gotg) {
        ...
        JanusVertex h = getOnlyVertex(gotg.query().has("name", "hercules"));
    ...
    public void testSimpleUpdate() {
        ...
        JanusVertex v = tx.addVertex("name", "Marko Rodriguez");
    ...
    public void testIndexing() {
        ...
        clopen();
        String[] words = {"world", "aurelius", "janus", "graph"};
        int numCategories = 5;
        int numGroups = 10;
    ...
    public void testInstantIndexing() {
        ...
        v1 = (JanusVertex) graph.vertices(v1.id()).next();
        v1.property("instant", firstTimestamp);
    ...
    private void testInstant(Instant firstTimestamp, Instant secondTimestamp, JanusVertex v1, JanusVertex v2) {
        assertEquals(v1, getOnlyVertex(graph.query().has("instant", Cmp.EQUAL, firstTimestamp)));
    ...
    public void testConditionalIndexing() {
        ...
        for (int i = 0; i < numV; i++) {
            JanusVertex v = tx.addVertex(i % 2 == 0 ? "person" : "org");
    ...
    private void setupChainGraph(int numV, String[] strs, boolean sameNameMapping) {
        ...
        JanusGraphIndex pindex = getExternalIndex(JanusVertexProperty.class, INDEX);
        PropertyKey name = makeKey("name", String.class);
        ...
        for (int i = 0; i < numV; i++) {
            JanusVertex v = graph.addVertex("name", strs[i % strs.length], "text", strs[i % strs.length]);
...
//        JanusVertex v = Iterables.getOnlyElement(tx.query().has("name",Text.CONTAINS,"long").vertices());
//        System.out.println(v.getProperty("age"));
    ...
    private void addVertex(int time, String text, double height, String[] phones) {
        newTx();
        JanusVertex v = tx.addVertex("text", text, "time", time, "height", height);
   ...
   /* ==================================================================================
    ...
    public void testVertexTTLWithMixedIndices() throws Exception {
        ...
        JanusVertex v2 = tx.addVertex("event");
    ...
    public void testEdgeTTLWithMixedIndices() throws Exception {
        ...
        JanusVertex v1 = tx.addVertex(), v2 = tx.addVertex(), v3 = tx.addVertex();
   ...
   /* ==================================================================================
    ...
    public void testIndexQueryWithScore() throws InterruptedException {
        ...
        for (JanusIndexQuery.Result<JanusVertex> r : graph.indexQuery("store1", "v.text:(Hello)").vertices()) {
    ...
    public void testContainsWithMultipleValues() throws Exception {
        ...
        JanusVertex r = Iterables.<JanusVertex>get(graph.query().has("name", Text.CONTAINS, "hercules here").vertices(), 0);
    ...
    private void testNestedWrites(String initialValue, String updatedValue) throws BackendException {
        ...
        JanusTransaction vertexDeleter = graph.newTransaction();
        JanusTransaction propDeleter = graph.newTransaction();
