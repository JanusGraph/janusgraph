 ...
 * Fulgora OLAP component of Janus.
 * <p/>
        ...
        for (int i=0;i<numVertices/verticesPerTask;i++) {
            ...
            exe.submit(new Runnable() {
                ...
                public void run() {
                    ...
                    JanusVertex[] vs = new JanusVertex[verticesPerTask];
                    ...
                    for (int j=0;j<verticesPerTask*10;j++) {
                        JanusEdge e = vs[random.nextInt(verticesPerTask)].addEdge("l",vs[random.nextInt(verticesPerTask)]);
