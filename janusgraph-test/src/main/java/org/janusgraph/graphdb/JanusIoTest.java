...
/**
 * Tests Janus specific serialization classes not covered by the TinkerPop suite.
 *
 * @author Stephen Mallette (http://stephen.genoprime.com)
 */
public abstract class JanusIoTest extends JanusGraphBaseTest {
    ...
    public void testGeoShapeSerializationReadWriteAsGraphSONEmbedded() throws Exception {
        ...
        JanusIndexTest.assertGraphOfTheGods(graph);
    }
