...
import org.janusgraph.graphdb.tinkerpop.optimize.JanusPropertiesStep;
...
import static org.janusgraph.testutil.JanusAssert.*;
...
public abstract class JanusGraphTest extends JanusGraphBaseTest {
  ...
  /* ==================================================================================
    ...
    public void testVertexRemoval() {
        ...
        JanusVertex v1 = graph.addVertex(namen, "v1");
        JanusVertex v2 = graph.addVertex(namen, "v2");
        v1.addEdge("knows", v2);
    ...
    public void testGlobalIteration() {
        ...
        JanusVertex previous = tx.addVertex("count", 0);
        for (int i = 1; i < numV; i++) {
            JanusVertex next = tx.addVertex("count", i);
        ...
        for (JanusVertex v : tx.query().limit(deleteV).vertices()) {
            v.remove();
        }
    ...
    public void testMediumCreateRetrieve() {
        ...
        JanusVertex[] nodes = new JanusVertex[noVertices];
        ...
        for (int i = 0; i < noVertices; i++) {
            ...
            for (int k : knowsOff) {
                JanusVertex n2 = nodes[wrapAround(i + k, noVertices)];
        ...
        for (int i = 0; i < noVertices; i++) {
            ...
            for (Object r : nodeEdges[i]) {
                nodeEdgeIds[i].add(((JanusEdge) r).longId());
            }
        }
        clopen();

        nodes = new JanusVertex[noVertices];
        for (int i = 0; i < noVertices; i++) {
            JanusVertex n = getVertex("uid", ids[i]);
        ...
        for (int i = 0; i < noVertices; i++) {
            ...
            for (JanusEdge r : n.query().direction(Direction.OUT).labels("knows").edges()) {
                JanusVertex n2 = r.vertex(Direction.IN);
            ...
            for (JanusEdge r : n.query().direction(Direction.OUT).edges()) {
                edgeIds.add(((JanusEdge) r).longId());
            }
    ...
    private void verifyVerticesRetrieval(long[] vids, List<JanusVertex> vs) {
...
//        } catch (IllegalArgumentException e) {}
        ...
        */
        ...
        //test edges
        JanusVertex v12 = tx.addVertex("person"), v13 = tx.addVertex("person");
        ...
        v.addEdge("link", v13);
        JanusVertex v2 = tx.addVertex("tweet");
        v2.addEdge("link", v13);
        ...
        for (JanusVertexProperty<String> prop : v.query().labels("name").properties()) {
            String nstr = prop.value();
            assertTrue(nstr.equals("Bob") || nstr.equals("John"));
        }
        assertTrue(size(v.properties("value")) >= 3);
        for (JanusVertexProperty<Double> prop : v.query().labels("value").properties()) {
    ...
    /**
     * Test the different data types that Janus supports natively and ensure that invalid data types aren't allowed
     */
    @Test
    public void testDataTypes() throws Exception {
        ...
        for (JanusVertexProperty prop : v.query().labels("any").properties()) {
    ...
    public void testSchemaNameChange() {
        ...
        //CREATE SMALL GRAPH
        JanusVertex v = tx.addVertex("people");
    ...
    public void testGotGIndexRemoval() throws InterruptedException, ExecutionException {
        ...
        JanusManagement.IndexJobFuture gmetrics = mgmt.getIndexJobStatus(gindex);
        finishSchema();
    ...
    public void testIndexUpdateSyncWithMultipleInstances() throws InterruptedException {
        ...
        StandardJanusGraph graph2 = (StandardJanusGraph) JanusFactory.open(config);
        JanusTransaction tx2;
        ...
        JanusTransaction tx3 = graph2.newTransaction();
   ...
   /* ==================================================================================
    ...
    public void testPropertyCardinality() {
        ...
        JanusVertex v1 = tx.addVertex();
        v1.property("name", "name1");
        JanusVertex v2 = tx.addVertex();
        v2.property("uid", 512);
    ...
    public void testImplicitKey() {
        JanusVertex v = graph.addVertex("name", "Dan"), u = graph.addVertex();
    ...
    public void testThreadBoundTx() {
        ...
        JanusVertex v1 = graph.addVertex("name", "Vertex1", "age", 35);
        JanusVertex v2 = graph.addVertex("name", "Vertex2", "age", 45);
        JanusVertex v3 = graph.addVertex("name", "Vertex3", "age", 55);
        ...
        for (JanusVertex v : new JanusVertex[]{v1, v2, v3}) {
            ...
            JanusEdge tmpE = getOnlyElement(v.query().direction(Direction.OUT).labels("knows").edges());
        ...
        graph.tx().commit();
        e4.property("type", 2);
        JanusEdge ef = getOnlyElement(v1.query().direction(Direction.OUT).labels("friend").edges());
        ...
        prop = (VertexProperty) ((Iterable) graph.multiQuery((JanusVertex) v1).properties().values().iterator().next()).iterator().next();
        assertTrue(getId(prop) > 0);
    ...
    public void testStaleVertex() {
        ...
        JanusVertex cartman = graph.addVertex("name", "cartman", "age", 10);
        JanusVertex stan = graph.addVertex("name", "stan", "age", 8);
        ...
        JanusVertexProperty p = (JanusVertexProperty) cartman.properties().next();
    ...
    public void testTransactionIsolation() {
        ...
        JanusTransaction tx1 = graph.newTransaction();
        JanusTransaction tx2 = graph.newTransaction();

        //Verify that using vertices across transactions is prohibited
        JanusVertex v11 = tx1.addVertex();
        JanusVertex v12 = tx1.addVertex();
        v11.addEdge("knows", v12);

        JanusVertex v21 = tx2.addVertex();
        try {
            v21.addEdge("knows", v11);
            fail();
        } catch (IllegalStateException e) {
        }
        JanusVertex v22 = tx2.addVertex();
        ...
        JanusTransaction tx3 = graph.buildTransaction().checkInternalVertexExistence(true).start();
        v21 = getV(tx3, v21);
        v3 = getOnlyElement(v21.query().direction(Direction.OUT).labels("link").vertices());
    ...
    public <V> void testMultivaluedVertexProperty() {
        ...
        for (String prop : new String[]{foo, bar}) {
            ...
            for (JanusVertexProperty<String> p : v.query().labels(foo).properties()) {
    ...
    public void testManagedOptionMasking() throws BackendException {
        ...
        } catch (JanusConfigurationException e) {
    ...
    public void testTransactionConfiguration() {
        ...
        JanusTransaction readOnlyTx = graph.buildTransaction().readOnly().start();
        try {
        ...
        String logID = "spam";
        StandardJanusTx customLogIDTx = (StandardJanusTx) graph.buildTransaction().logIdentifier(logID).start();
        ...
        StandardJanusTx customTimeTx = (StandardJanusTx) graph.buildTransaction().commitTime(customTimestamp).start();
    ...
    private <T> void setAndCheckGraphOption(ConfigOption<T> opt, ConfigOption.Type requiredType, T firstValue, T secondValue) {
        ...
        JanusGraph g2 = JanusFactory.open(config);
        JanusManagement m2 = g2.openManagement();
   ...
   /* ==================================================================================
    ...
    public void testConsistencyEnforcement() {
        ...
        JanusVertex v1 = tx.addVertex("uid", 1);
        JanusVertex v2 = tx.addVertex("uid", 2);
        JanusVertex v3 = tx.addVertex("uid", 3);
        ...
        executeLockConflictingTransactionJobs(graph, new TransactionJob() {
            ...
            @Override
            public void run(JanusTransaction tx) {
                JanusVertex u = getV(tx, vids[pos++]);
        ...
        executeLockConflictingTransactionJobs(graph, new TransactionJob() {
            @Override
            public void run(JanusTransaction tx) {
                JanusVertex u1 = getV(tx, vids[0]), u2 = getV(tx, vids[1]);
                u1.addEdge("knows", u2);
            }
        });
        ...
        executeLockConflictingTransactionJobs(graph, new TransactionJob() {
            ...
            @Override
            public void run(JanusTransaction tx) {
                JanusVertex u1 = getV(tx, vids[pos++]),
                        u2 = getV(tx, vids[0]);
                u1.addEdge("spouse", u2);
            }
        });
    ...
    public void testConcurrentConsistencyEnforcement() throws Exception {
        ...
        JanusVertex baseV = tx.addVertex("name", "base");
        newTx();
        ...
        int numSuccess = executeParallelTransactions(new TransactionJob() {
            @Override
            public void run(JanusTransaction tx) {
                JanusVertex a = tx.addVertex();
                JanusVertex base = getV(tx, baseVid);
        ...
        numSuccess = executeParallelTransactions(new TransactionJob() {
            @Override
            public void run(JanusTransaction tx) {
                JanusVertex a = tx.addVertex("name", nameA);
                JanusVertex b = tx.addVertex("name", nameB);
                b.addEdge("friend", b);
            }
        }, parallelThreads);
...
//        System.out.println(numA + " - " + numB);
   ...
   /* ==================================================================================
    ...
    public void testVertexCentricQuery(int noVertices) {
        ...
        JanusVertex v = tx.addVertex("name", "v");
        JanusVertex u = tx.addVertex("name", "u");
        assertEquals(0, (noVertices - 1) % 3);
        JanusVertex[] vs = new JanusVertex[noVertices];
        ...
        for (int i = 1; i < noVertices; i++) {
            for (JanusVertex vertex : new JanusVertex[]{v, u}) {
                for (Direction d : new Direction[]{OUT, IN}) {
                    EdgeLabel label = vertex == v ? labelsV[i % 3] : labelsU[i % 3];
                    JanusEdge e = d == OUT ? vertex.addEdge(n(label), vs[i]) :
        ...
        VertexList vl;
        Map<JanusVertex, Iterable<JanusEdge>> results;
        Map<JanusVertex, Iterable<JanusVertexProperty>> results2;
        JanusVertex[] qvs;
        int lastTime;
        ...
        v = getV(tx, v.longId());
        u = getV(tx, u.longId());
        qvs = new JanusVertex[]{vs[6], vs[9], vs[12], vs[15], vs[60]};
        ...
        lastTime = 0;
        for (JanusEdge e : (Iterable<JanusEdge>) v.query().labels("connect").direction(OUT).limit(20).edges()) {
            int nowTime = e.value("time");
            assertTrue(lastTime + " vs. " + nowTime, lastTime <= nowTime);
            lastTime = nowTime;
        }
        lastTime = Integer.MAX_VALUE;
        for (Edge e : (Iterable<JanusEdge>) u.query().labels("connectDesc").direction(OUT).limit(20).edges()) {
            int nowTime = e.value("time");
            assertTrue(lastTime + " vs. " + nowTime, lastTime >= nowTime);
            lastTime = nowTime;
        }
        ...
        for (Edge e : (Iterable<JanusEdge>) v.query().labels("connect").direction(OUT).limit(10).edges()) {
        ...
        for (Iterable<JanusEdge> result : results.values()) assertEquals(1, size(result));
        results = tx.multiQuery(Sets.newHashSet(qvs)).labels("connect").edges();
        for (Iterable<JanusEdge> result : results.values()) assertEquals(2, size(result));
        results = tx.multiQuery(qvs).labels("knows").edges();
        for (Iterable<JanusEdge> result : results.values()) assertEquals(0, size(result));
        results = tx.multiQuery(qvs).edges();
        for (Iterable<JanusEdge> result : results.values()) assertEquals(4, size(result));
        results2 = tx.multiQuery(qvs).properties();
        for (Iterable<JanusVertexProperty> result : results2.values()) assertEquals(1, size(result));
        ...
        lastTime = 0;
        for (Edge e : (Iterable<JanusEdge>) v.query().labels("connect").direction(OUT).limit(20).edges()) {
            int nowTime = e.value("time");
            assertTrue(lastTime + " vs. " + nowTime, lastTime <= nowTime);
            lastTime = nowTime;
        }
        ...
        JanusVertex[] qvs2 = new JanusVertex[qvs.length + 2];
        qvs2[0] = tx.addVertex();
...
//        } catch (IllegalArgumentException e) {}
        ...
        */
        ...
        final int numV = 100;
        JanusVertex v = tx.addVertex();
        JanusVertex ns[] = new JanusVertex[numV];
        ...
        for (JanusVertexProperty<String> p : v.query().labels("name").properties()) {
            if (p.<Long>value("time") < (numV / 2)) p.remove();
        }
        for (JanusEdge e : v.query().direction(BOTH).edges()) {
            if (e.<Long>value("time") < (numV / 2)) e.remove();
        }
        ns = new JanusVertex[numV * 3 / 2];
        for (int i = numV; i < numV * 3 / 2; i++) {
            ...
            ns[i] = tx.addVertex();
            for (String label : new String[]{"connect", "child", "link"}) {
                JanusEdge e = v.addEdge(label, ns[i], "weight", w, "time", t);
            }
        }
    ...
    public static void evaluateQuery(JanusVertexQuery query, RelationCategory resultType,
    ...
    public static void evaluateQuery(JanusVertexQuery query, RelationCategory resultType,
        ...
        Iterable<? extends JanusElement> result;
        switch (resultType) {
            case PROPERTY:
        ...
        int no = 0;
        JanusElement previous = null;
        for (JanusElement e : result) {
            assertNotNull(e);
            no++;
    ...
    public void testEdgesExceedCacheSize() {
        ...
        JanusVertex parentVertex = graph.addVertex();
        for (int i = 0; i < numEdges; i++) {
            JanusVertex childVertex = graph.addVertex();
    ...
    public void testTinkerPopOptimizationStrategies() {
        ...
        int numV = 100;
        JanusVertex[] vs = new JanusVertex[numV];
        for (int i = 0; i < numV; i++) {
            vs[i] = graph.addVertex("id", i, "weight", i % 5);
        }
        int superV = 10;
        int sid = -1;
        JanusVertex[] sv = new JanusVertex[superV];
        ...
        //Edge
        assertNumStep(numV / 5, 1, gts.V(sv[0]).outE("knows").has("weight", 1), JanusVertexStep.class);
        assertNumStep(numV, 1, gts.V(sv[0]).outE("knows"), JanusVertexStep.class);
        assertNumStep(numV, 1, gts.V(sv[0]).out("knows"), JanusVertexStep.class);
        assertNumStep(10, 1, gts.V(sv[0]).local(__.outE("knows").limit(10)), JanusVertexStep.class);
        assertNumStep(10, 1, gts.V(sv[0]).local(__.outE("knows").range(10, 20)), LocalStep.class);
        assertNumStep(numV, 2, gts.V(sv[0]).outE("knows").order().by("weight", decr), JanusVertexStep.class, OrderGlobalStep.class);
        assertNumStep(10, 1, gts.V(sv[0]).local(__.outE("knows").order().by("weight", decr).limit(10)), JanusVertexStep.class);
        assertNumStep(numV / 5, 2, gts.V(sv[0]).outE("knows").has("weight", 1).order().by("weight", incr), JanusVertexStep.class, OrderGlobalStep.class);
        assertNumStep(10, 1, gts.V(sv[0]).local(__.outE("knows").has("weight", 1).order().by("weight", incr).limit(10)), JanusVertexStep.class);
        ...
        assertNumStep(1, 1, gts.V(sv[0]).outE("knows").filter(__.inV().is(vs[50])), JanusVertexStep.class);
        assertNumStep(1, 1, gts.V(sv[0]).outE("knows").filter(__.otherV().is(vs[50])), JanusVertexStep.class);
        assertNumStep(1, 1, gts.V(sv[0]).bothE("knows").filter(__.otherV().is(vs[50])), JanusVertexStep.class);
        assertNumStep(1, 2, gts.V(sv[0]).bothE("knows").filter(__.inV().is(vs[50])), JanusVertexStep.class, TraversalFilterStep.class);

        //Property
        assertNumStep(numV / 5, 1, gts.V(sv[0]).properties("names").has("weight", 1), JanusPropertiesStep.class);
        assertNumStep(numV, 1, gts.V(sv[0]).properties("names"), JanusPropertiesStep.class);
        assertNumStep(10, 1, gts.V(sv[0]).local(__.properties("names").order().by("weight", decr).limit(10)), JanusPropertiesStep.class);
        assertNumStep(numV, 2, gts.V(sv[0]).outE("knows").values("weight"), JanusVertexStep.class, JanusPropertiesStep.class);
        ...
        assertNumStep(superV * (numV / 5), 2, gts.V().has("id", sid).outE("knows").has("weight", 1), JanusGraphStep.class, JanusVertexStep.class);
        assertNumStep(superV * (numV / 5 * 2), 2, gts.V().has("id", sid).outE("knows").has("weight", P.gte(1)).has("weight", P.lt(3)), JanusGraphStep.class, JanusVertexStep.class);
        assertNumStep(superV * (numV / 5 * 2), 2, gts.V().has("id", sid).outE("knows").has("weight", P.between(1, 3)), JanusGraphStep.class, JanusVertexStep.class);
        assertNumStep(superV * 10, 2, gts.V().has("id", sid).local(__.outE("knows").has("weight", P.gte(1)).has("weight", P.lt(3)).limit(10)), JanusGraphStep.class, JanusVertexStep.class);
        assertNumStep(superV * 10, 2, gts.V().has("id", sid).local(__.outE("knows").has("weight", P.between(1, 3)).order().by("weight", decr).limit(10)), JanusGraphStep.class, JanusVertexStep.class);
        ...
        assertNumStep(superV * 10, 2, gts.V().has("id", sid).local(__.outE("knows").has("weight", P.gte(1)).has("weight", P.lt(3)).limit(10)), JanusGraphStep.class, JanusVertexStep.class);
        assertNumStep(superV * 10, 2, gts.V().has("id", sid).local(__.outE("knows").has("weight", P.between(1, 3)).order().by("weight", decr).limit(10)), JanusGraphStep.class, JanusVertexStep.class);
        assertNumStep(superV * numV, 2, gts.V().has("id", sid).values("names"), JanusGraphStep.class, JanusPropertiesStep.class);
...
//        System.out.println(traversal);
        ...
        //Verify that steps line up with what is expected after Janus's optimizations are applied
...
//                System.out.println(header.getTimestamp(TimeUnit.MILLISECONDS));
         ...
         */
        TransactionRecovery recovery = JanusFactory.startTransactionRecovery(graph, startTime);
        ...
        LogProcessorFramework userlogs = JanusFactory.openTransactionLog(graph);
        userlogs.addLogProcessor(userlogName).setStartTime(startTime).setRetryAttempts(1)
                .addProcessor(new ChangeProcessor() {
                    @Override
                    public void process(JanusTransaction tx, TransactionId txId, ChangeState changes) {
                        ...
                        if (txTimeMicro.isBefore(txTimes[1])) {
                            ...
                            JanusVertex v = Iterables.getOnlyElement(changes.getVertices(Change.ADDED));
                            ...
                            JanusVertex v = Iterables.getOnlyElement(changes.getVertices(Change.REMOVED));
                            assertEquals(v2id, getId(v));
                            ...
                            JanusVertex v = Iterables.getOnlyElement(changes.getVertices(Change.ANY));
                            assertEquals(v1id, getId(v));
                            JanusEdge e = Iterables.getOnlyElement(changes.getEdges(v, Change.REMOVED, Direction.OUT, "knows"));
                            assertFalse(e.property("weight").isPresent());
...
//                    assertTrue(txNo + " - " + v2, v2 == null || v2.isRemoved());
   ...
   /* ==================================================================================
    ...
    public void testGlobalGraphIndexingAndQueriesForInternalIndexes() {
        ...
        JanusGraphIndex prop1 = mgmt.buildIndex("prop1", JanusVertexProperty.class).addKey(time).buildCompositeIndex();
        JanusGraphIndex prop2 = mgmt.buildIndex("prop2", JanusVertexProperty.class).addKey(weight).addKey(text).buildCompositeIndex();
        ...
        assertEquals(2, Iterables.size(mgmt.getGraphIndexes(JanusVertexProperty.class)));
        ...
        assertTrue(JanusVertexProperty.class.isAssignableFrom(prop1.getIndexedElement()));
        ...
        for (int i = 0; i < numV; i++) {
            ...
            JanusVertex u = ns[(i > 0 ? i - 1 : i)]; //previous or self-loop
        ...
        for (int i = numV; i < numV * 3 / 2; i++) {
            ...
            JanusVertex u = ns[(i > numV ? i - 1 : i)]; //previous or self-loop
            for (String label : new String[]{"connect", "related"}) {
                Edge e = ns[i].addEdge(label, u, "weight", (w++) % 5, "time", t, "text", txt);
            }
        }
    ...
    public void testIndexUniqueness() {
        ...
        failTransactionOnCommit(new TransactionJob() {
            @Override
            public void run(JanusTransaction tx) {
                JanusVertex v0 = tx.addVertex("person");
                v0.property(VertexProperty.Cardinality.single, "time", 1);
                JanusVertex v1 = tx.addVertex("person");
        ...
        JanusVertex v1 = tx.addVertex("organization");
        v1.property(VertexProperty.Cardinality.single, "time", 1);
        newTx();
        ...
        failTransactionOnCommit(new TransactionJob() {
            @Override
            public void run(JanusTransaction tx) {
                JanusVertex v0 = tx.addVertex("time", 2, "text", "hello");
                JanusVertex v1 = tx.addVertex("time", 2, "text", "hello");
            }
        });
    ...
    public void testForceIndexUsage() {
        ...
        for (int i = 1; i <= 10; i++) {
            JanusVertex v = tx.addVertex("time", i, "age", i);
        }
    ...
    public void testIndexQueryWithLabelsAndContainsIN() {
        ...
        JanusVertex foo = graph.addVertex(labelName);
        JanusVertex bar = graph.addVertex(labelName);
        foo.property("uid", "foo");
        bar.property("uid", "bar");
        graph.tx().commit();

        Iterable<JanusVertex> vertexes = graph.query()
                .has("uid", Contain.IN, ImmutableList.of("foo", "bar"))
                .has(LABEL_NAME, labelName)
                .vertices();
        assertEquals(2, Iterables.size(vertexes));
        for (JanusVertex v : vertexes) {
    ...
    public void testLimitWithMixedIndexCoverage() {
        ...
        JanusVertex a = tx.addVertex(vt, user, fn, "alice");
        JanusVertex b = tx.addVertex(vt, user, fn, "bob");
        JanusVertex v;
    ...
    public void testHasNot() {
        ...
        v2 = (JanusVertex) graph.query().hasNot("abcd").vertices().iterator().next();
        assertEquals(v1, v2);
        v2 = (JanusVertex) graph.query().hasNot("abcd", true).vertices().iterator().next();
        assertEquals(v1, v2);
    }
    ...
    public void testVertexCentricIndexWithNull() {
        ...
        JanusVertex v1 = tx.addVertex(), v2 = tx.addVertex();
    ...
    public void testCreateDelete() {
        ...
        JanusVertex v1 = graph.addVertex(), v3 = graph.addVertex("uid", 445);
   ...
   /* ==================================================================================
    ...
    public void testEdgeTTLTiming() throws Exception {
        ...
        JanusVertex v1 = graph.addVertex(), v2 = graph.addVertex(), v3 = graph.addVertex();
    ...
    public void testPropertyTTLTiming() throws Exception {
        ...
        JanusVertex v1 = tx.addVertex(T.label, "event", "name", "some event", "place", "somewhere");
    ...
    public void testVertexTTLWithCompositeIndex() throws Exception {
        ...
        JanusVertex v1 = tx.addVertex(T.label, "event", "name", "some event", "time", System.currentTimeMillis());
        tx.commit();
        Object id = v1.id();
    ...
    public void testSettingTTLOnUnsupportedType() throws Exception {
        ...
        JanusSchemaType type = ImplicitKey.ID;
    ...
    public void testUnsettingTTL() throws InterruptedException {
        ...
        JanusVertex v1 = graph.addVertex();
        JanusVertex v2 = graph.addVertex();
        v1.addEdge("likes", v2);
        graph.tx().commit();
    ...
    public void testVertexTTLImplicitKey() throws Exception {
        ...
        JanusVertex v1 = tx.addVertex("event");
        JanusVertex v2 = tx.addVertex();
        tx.commit();
