...
import org.janusgraph.blueprints.TuplGraphProvider;
...
@GraphProviderClass(provider = TuplGraphProvider.class, graph = JanusGraph.class)
public class TuplJanusGraphGroovyEnvironmentPerformanceTest {
}
