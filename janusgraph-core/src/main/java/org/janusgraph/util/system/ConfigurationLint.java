...
public class ConfigurationLint {
    ...
    public static void main(String args[]) throws IOException {
        if (1 != args.length) {
            System.err.println("Usage: ConfigurationLint janus.properties");
...
//                , BasicConfiguration.Restriction.NONE);
        ...
        while (iter.hasNext()) {
            ...
            try {
                ...
                // ConfigElement shouldn't return null; failure here probably relates to janus-core, not the file
