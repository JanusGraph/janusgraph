...
/**
 * Singleton that contains and configures Janus's {@code MetricRegistry}.
 */
public enum MetricManager {
    ...
    /**
     * Return the Janus Metrics registry.
     *
     * @return the single {@code MetricRegistry} used for all of Janus's Metrics
     *         monitoring
     */
    ...
    /**
     * Create a {@link ConsoleReporter} attached to the Janus Metrics registry.
     *
    ...
    /**
     * Create a {@link CsvReporter} attached to the Janus Metrics registry.
     * <p>
    ...
    /**
     * Create a {@link JmxReporter} attached to the Janus Metrics registry.
     * <p>
    ...
    /**
     * Create a {@link Slf4jReporter} attached to the Janus Metrics registry.
     * <p>
    ...
    /**
     * Create a {@link GangliaReporter} attached to the Janus Metrics registry.
     * <p>
    ...
    /**
     * Create a {@link GraphiteReporter} attached to the Janus Metrics registry.
     * <p>
    ...
    /**
     * Remove all Janus Metrics reporters previously configured through the
