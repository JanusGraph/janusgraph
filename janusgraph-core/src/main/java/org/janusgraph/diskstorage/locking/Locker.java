...
/**
 * Threadsafe discretionary locking within and between processes Janus.
 * <p>
 ...
 * nonblocking and blocking locking primitives. Not all Janus
 * {@code StoreTransaction}s will need locks and use this interface. For those
 * {@code StoreTransaction}s that do take one or more locks, Janus will call the
