...
/**
 * Helper class for inspecting and modifying a configuration for Janus.
 * It is important to {@link #close()} the configuration when all changes have been made.
 *
 * @author Matthias Broecheler (me@matthiasb.com)
 */
public class UserModifiableConfiguration implements JanusConfiguration {
     ...
     * to create and configure a Janus graph.
     *
     * @return
     */
