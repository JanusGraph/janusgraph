 ...
 */
public class JanusIoRegistry extends AbstractIoRegistry {

    private static JanusIoRegistry INSTANCE = new JanusIoRegistry();
    ...
    public static JanusIoRegistry getInstance() {
        return INSTANCE;
    }
}
