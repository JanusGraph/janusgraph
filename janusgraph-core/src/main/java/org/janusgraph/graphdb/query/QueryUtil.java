...
public class QueryUtil {
    ...
    public static int adjustLimitForTxModifications(StandardJanusTx tx, int uncoveredAndConditions, int limit) {
    ...
    public static InternalRelationType getType(StandardJanusTx tx, String typeName) {
    ...
    public static Iterable<JanusVertex> getVertices(StandardJanusTx tx,
    ...
    public static Iterable<JanusEdge> getEdges(StandardJanusTx tx,
                                                    PropertyKey key, Object equalityCondition) {
    ...
    /**
     * Query-normal-form (QNF) for Janus is a variant of CNF (conjunctive normal form) with negation inlined where possible
     *
     * @param condition
     * @return
     */
    ...
    private static final <E extends JanusElement> Condition<E> inlineNegation(Condition<E> condition) {
    ...
    public static final <E extends JanusElement> Condition<E> simplifyQNF(Condition<E> condition) {
     ...
     */
    public static <E extends JanusElement> And<E> constraints2QNF(StandardJanusTx tx, List<PredicateCondition<String, E>> constraints) {
        ...
        for (PredicateCondition<String, E> atom : constraints) {
            ...
            JanusPredicate predicate = atom.getPredicate();
            ...
            if (type.isPropertyKey()) {
                ...
                Preconditions.checkArgument(predicate.isValidValueType(JanusVertex.class), "Data type of key is not compatible with condition");
            }
    ...
    private static <E extends JanusElement> void addConstraint(RelationType type, JanusPredicate predicate,
                                                               Object value, MultiCondition<E> conditions, StandardJanusTx tx) {
        if (type.isPropertyKey()) {
            if (value != null)
                value = tx.verifyAttribute((PropertyKey) type, value);
        } else { //t.isEdgeLabel()
            Preconditions.checkArgument(value instanceof JanusVertex);
        }
    ...
    public static Map.Entry<RelationType,Collection> extractOrCondition(Or<JanusRelation> condition) {
        ...
        do {
            ...
            for (IndexCall<R> call : retrievals) {
                ...
                try {
                    ...
                    throw new JanusException("Could not process individual retrieval call ", e);
                }
