 ...
 */
public class GraphCentricQuery extends BaseQuery implements ElementQuery<JanusElement, JointIndexQuery>, ProfileObservable {

    /**
     * The condition of this query, the result set is the set of all elements in the graph for which this
     * condition evaluates to true.
     */
    private final Condition<JanusElement> condition;
    /**
    ...
    public GraphCentricQuery(ElementCategory resultType, Condition<JanusElement> condition, OrderList orders,
    ...
    public static final GraphCentricQuery emptyQuery(ElementCategory resultType) {
        Condition<JanusElement> cond = new FixedCondition<JanusElement>(false);
    ...
    @Override
    public Comparator<JanusElement> getSortOrder() {
    ...
    @Override
    public boolean matches(JanusElement element) {
