 ...
 * Responsible for the bit-wise pattern of Janus's internal id scheme.
 *
...
public class IDManager {
    ...
    /**
     * Total number of bits available to a Janus assigned id
   ...
   ########################################################  */
    ...
    /* --- JanusRelation Type id bit format ---
      *  [ 0 | count | ID padding ]
