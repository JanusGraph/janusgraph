...
public class OrderList implements Comparator<JanusElement>, Iterable<OrderList.OrderEntry> {
    ...
    @Override
    public int compare(JanusElement o1, JanusElement o2) {
...
//        return o1.compareTo(o2);
    ...
    public static class OrderEntry implements Comparator<JanusElement> {
