...
/**
 * Internal Vertex interface adding methods that should only be used by Janus
 *
 * @author Matthias Broecheler (me@matthiasb.com)
 */
public interface InternalVertex extends JanusVertex, InternalElement {
     ...
     *
     * @param e JanusRelation to be removed
     */
