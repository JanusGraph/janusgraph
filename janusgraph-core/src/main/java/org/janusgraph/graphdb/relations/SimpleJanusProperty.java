 ...
 */
public class SimpleJanusProperty<V> implements JanusProperty<V> {

    private final PropertyKey key;
    private final V value;
    private final InternalRelation relation;

    public SimpleJanusProperty(InternalRelation relation, PropertyKey key, V value) {
        this.key = key;
        this.value = value;
