...
public abstract class IndexTypeWrapper implements IndexType {
    ...
    private volatile JanusSchemaType schemaTypeConstraint = null;
    ...
    public JanusSchemaType getSchemaTypeConstraint() {
        ...
        if (!cachedTypeConstraint) {
            ...
            if (Iterables.isEmpty(related)) {
                ...
                constraint =
                        (JanusSchemaType)Iterables.getOnlyElement(related,null).getSchemaType();
