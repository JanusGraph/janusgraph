...
public abstract class StandardRelationTypeMaker implements RelationTypeMaker {
    ...
    public StandardRelationTypeMaker(final StandardJanusTx tx, String name,
    ...
    abstract JanusSchemaCategory getSchemaCategory();
     ...
     * time interval using {@link org.janusgraph.core.JanusVertexQuery#interval(org.janusgraph.core.PropertyKey, Comparable, Comparable)}.
     * <br />
     ...
     *
     * @param keys JanusTypes composing the sort key. The order is relevant.
