...
public class ManagementLogger implements MessageReader {
    ...
    public void sendCacheEviction(Set<JanusSchemaVertex> updatedTypes,
        ...
        for (JanusSchemaVertex type : updatedTypes) {
            assert type.hasId();
    ...
    private class SendAckOnTxClose implements Runnable {
        ...
        private final Set<? extends JanusTransaction> openTx;
        private final String originId;

        private SendAckOnTxClose(long evictionId, String originId, Set<? extends JanusTransaction> openTx) {
            this.evictionId = evictionId;
            this.openTx = openTx;
...
//            long startTime = Timestamps.MICRO.getTime();
            ...
            while (true) {
                ...
                Iterator<? extends JanusTransaction> iter = openTx.iterator();
                while (iter.hasNext()) {
