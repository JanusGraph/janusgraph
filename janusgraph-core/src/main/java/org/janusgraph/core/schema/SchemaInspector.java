...
public interface SchemaInspector {
    ...
    */
    ...
    /**
     * Checks whether a property key of the given name has been defined in the Janus schema.
     *
    ...
    /**
     * Checks whether an edge label of the given name has been defined in the Janus schema.
     *
