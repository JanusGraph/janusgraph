 ...
 * <p/>
 * VertexList is returned by {@link JanusVertexQuery}. Depending on how the query was executed that returned this VertexList,
 * getting vertex ids might be significantly faster than retrieving vertex objects.
 *
 * @author Matthias Br&ouml;cheler (http://www.matthiasb.com)
 */
public interface VertexList extends Iterable<JanusVertex> {
     ...
     * @return JanusVertex at the given position
     */
