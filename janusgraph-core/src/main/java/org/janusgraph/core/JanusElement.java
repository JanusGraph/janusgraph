...
/**
 * JanusElement represents the abstract concept of an entity in the graph and specifies basic methods for interacting
 * with entities.
 * The two basic entities in a graph database are {@link JanusRelation} and {@link JanusVertex}.
 * Entities have a life cycle state which reflects the current state of the entity with respect
 * to the {@link JanusTransaction} in which it occurs. An entity may be in any one of these states
 * and any given time:
 * <ul>
 ...
 * @see JanusRelation
 */
public interface JanusElement extends Element, Idfiable, Removable {
     ...
     * <p/>
     * Janus allocates blocks of identifiers and automatically assigns identifiers to elements
