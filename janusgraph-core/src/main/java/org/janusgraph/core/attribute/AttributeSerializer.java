 ...
 * Janus will be sufficient and efficient in practice. However, for certain data types, it can be more
 ...
 * @see <a href="http://s3.thinkaurelius.com/docs/janus/current/serializer.html">
