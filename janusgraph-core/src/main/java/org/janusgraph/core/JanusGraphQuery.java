 ...
 * been defined for the keys. See {@link org.janusgraph.core.schema.JanusManagement} for more information
 * on how to define index structures in Janus.
 *
...
public interface JanusGraphQuery<Q extends JanusGraphQuery<Q>> {
    ...
    */
     ...
     * @return This query
     */
    public Q has(String key, JanusPredicate predicate, Object condition);
