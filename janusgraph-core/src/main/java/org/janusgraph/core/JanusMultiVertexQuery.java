...
/**
 * A MultiVertexQuery is identical to a {@link JanusVertexQuery} but executed against a set of vertices simultaneously.
 * In other words, {@link JanusMultiVertexQuery} allows identical {@link JanusVertexQuery} executed against a non-trivial set
 * of vertices to be executed in one batch which can significantly reduce the query latency.
 * <p/>
 * The query specification methods are identical to {@link JanusVertexQuery}. The result set method return Maps from the specified
 * set of anchor vertices to their respective individual result sets.
 * <p/>
 * Call {@link JanusTransaction#multiQuery(java.util.Collection)} to construct a multi query in the enclosing transaction.
 * <p/>
 ...
 */
public interface JanusMultiVertexQuery<Q extends JanusMultiVertexQuery<Q>> extends BaseVertexQuery<Q> {
