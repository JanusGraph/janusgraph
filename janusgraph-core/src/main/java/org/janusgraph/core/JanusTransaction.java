...
/**
 * JanusTransaction defines a transactional context for a {@link JanusGraph}. Since JanusGraph is a transactional graph
 * database, all interactions with the graph are mitigated by a JanusTransaction.
 * <p/>
 ...
 */
public interface JanusTransaction extends JanusGraphTransaction {
    ...
    */
     ...
     * @return New vertex
     */
    public JanusVertex addVertex(Long id, VertexLabel vertexLabel);
     ...
     */
    public JanusVertex getVertex(long id);
