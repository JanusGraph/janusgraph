...
/**
 * A vertex label is a label attached to vertices in a Janus graph. This can be used to define the nature of a
 * vertex.
 * <p />
 ...
 */
public interface VertexLabel extends JanusVertex, JanusSchemaType {
