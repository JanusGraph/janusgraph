...
/**
 * JanusRelation is the most abstract form of a relation between a vertex and some other entity, where
 * relation is understood in its mathematical sense. It generalizes the notion of an edge and a property.
 * <br />
 * A JanusRelation extends {@link JanusElement} which means it is an entity in its own right. This means, a JanusRelation
 * can have properties and unidirectional edges connecting it to other vertices.
 * <br />
 * A JanusRelation is an abstract concept. A JanusRelation is either a {@link JanusVertexProperty} or a {@link JanusEdge}.
 * A JanusRelation has a type which is either a label or key depending on the implementation.
 * <br />
 * A JanusRelation is either directed, or unidirected. Properties are always directed (connecting a vertex
 ...
 * @see JanusEdge
 * @see JanusVertexProperty
 */
public interface JanusRelation extends JanusElement {
