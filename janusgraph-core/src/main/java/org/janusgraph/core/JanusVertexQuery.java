...
/**
 * A JanusVertexQuery is a VertexQuery executed for a single vertex.
 * <p />
 * Calling {@link org.janusgraph.core.JanusVertex#query()} builds such a query against the vertex
 ...
 */
public interface JanusVertexQuery<Q extends JanusVertexQuery<Q>> extends BaseVertexQuery<Q> {
