...
/**
 * JanusFactory is used to open or instantiate a Janus graph database.
 *
...
public class JanusFactory {
    ...
    private static final Logger log =
            LoggerFactory.getLogger(JanusFactory.class);

    /**
     * Opens a {@link JanusGraph} database.
     * <p/>
     * If the argument points to a configuration file, the configuration file is loaded to configure the Janus graph
     * If the string argument is a configuration short-cut, then the short-cut is parsed and used to configure the returned Janus graph.
     * <p />
     ...
     * @return Janus graph database configured according to the provided configuration
     * @see <a href="http://s3.thinkaurelius.com/docs/janus/current/configuration.html">"Configuration" manual chapter</a>
     * @see <a href="http://s3.thinkaurelius.com/docs/janus/current/janus-config-ref.html">Configuration Reference</a>
     */
    ...
    /**
     * Returns a {@link Builder} that allows to set the configuration options for opening a Janus graph database.
     * <p />
     * In the builder, the configuration options for the graph can be set individually. Once all options are configured,
     * the graph can be opened with {@link org.janusgraph.core.JanusFactory.Builder#open()}.
     *
     * @return
     */
    ...
    public static class Builder {
        ...
        /**
         * Opens a Janus graph with the previously configured options.
         *
         * @return
         */
    ...
    /**
     * Load a properties file containing a Janus graph configuration.
     * <p/>
     * <ol>
    ...
    private static ReadConfiguration getLocalConfiguration(File file) {
        ...
        try {
            ...
            if (null == tmpParent) {
                /*
                 * null usually means we were given a Janus config file path
