...
public class TitanCassandraOutputFormatTest extends TitanOutputFormatTest {
    ...
    public void testBulkLoading() throws Exception {
        startUpCassandra();
        HadoopGraph f1 = createFaunusGraph(TitanCassandraOutputFormat.class.getResourceAsStream("graphson-cassandra.properties"));
    ...
    public void testBulkElementDeletions() throws Exception {
        startUpCassandra();
        HadoopGraph f1 = createFaunusGraph(TitanCassandraOutputFormat.class.getResourceAsStream("graphson-cassandra.properties"));
        HadoopGraph f2 = createFaunusGraph(TitanCassandraOutputFormat.class.getResourceAsStream("cassandra-cassandra.properties"));
