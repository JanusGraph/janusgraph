...
* All @FaunusVertex@ and @FaunusEdge@ construction leverages Hadoop @Configuration@ for deserialization rules
...
* Moved all default properties files from @bin/@ to @conf/@ to be consistent with Titan's distribution
...
* Provided MapReduce-based integration testing between Titan and Faunus
* Provided MapReduce-based integration testing around @FaunusPipeline@
