/* janus-schema.groovy
 *
 * Helper functions for declaring Janus schema elements
 * (vertex labels, edge labels, property keys) to accommodate
 * TP3 sample data.
 *
 * Sample usage in a gremlin.sh session:
 *
 * gremlin> :load data/janus-schema-grateful-dead.groovy
 * ==>true
 * ==>true
 * gremlin> t = JanusFactory.open('conf/janus-cassandra.properties')
