...
It is possible to use http://tinkerpop.apache.org/docs/$MAVEN{tinkerpop.version}/reference#_elementidstrategy[ElementIdStrategy] with JanusGraph. ElementIdStrategy allow an arbitrary property to be used as the element ID instead of JanusGraph's long identifiers.
