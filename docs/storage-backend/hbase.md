...
- by [Amazon EC2](http://aws.amazon.com/ec2/)
...
The following commands first launch a four-node HBase cluster on EC2 via [Whirr](http://whirr.apache.org/), then run a basic JanusGraph test case using the cluster.
