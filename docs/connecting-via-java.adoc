...
JanusGraph can be queried from a Java application with Apache TinkerPop's http://tinkerpop.apache.org/docs/{tinkerpop_version}/reference/#connecting-via-java[Gremlin Driver].
...
Other terminal steps can be found http://tinkerpop.apache.org/docs/{tinkerpop_version}/reference/#terminal-steps[in TinkerPop's reference documentation].
