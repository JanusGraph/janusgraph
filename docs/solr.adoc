...
[quote, 'https://lucene.apache.org/solr/[Apache Solr Homepage]']
...
JanusGraph supports https://lucene.apache.org/solr/[Apache Solr] as an index backend.  Here are some of the Solr features supported by JanusGraph:
...
Install DataStax Enterprise as directed by the page https://www.datastax.com/documentation/datastax_enterprise/4.5/datastax_enterprise/install/installTARdse.html[Installing DataStax Enterprise using the binary tarball].
