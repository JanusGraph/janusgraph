package com.thinkaurelius.titan.blueprints.ehcache;
...
public class EhCacheBlueprintsTest extends TitanBlueprintsTest {
    ...
    public Graph generateGraph(final String subdir) {
        String dir = EhCacheStorageSetup.getHomeDir() + "/" + subdir;
        Configuration config= new BaseConfiguration();
        config.subset(STORAGE_NAMESPACE).addProperty(STORAGE_DIRECTORY_KEY, dir);
        config.subset(STORAGE_NAMESPACE).addProperty(STORAGE_BACKEND_KEY, "ehcache");
