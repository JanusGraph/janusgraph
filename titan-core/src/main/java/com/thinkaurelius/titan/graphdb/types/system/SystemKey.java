...
public class SystemKey extends SystemType implements TitanKey {
    ...
    public static final SystemKey TypeDefinitionProperty =
            new SystemKey("TypeDefinitionProperty", Object.class, 2, false, new boolean[]{false, false}, false);
    ...
    public static final SystemKey TypeDefinitionDesc =
            new SystemKey("TypeDefinitionDescription", TypeDefinitionDescription.class, 4, false, new boolean[]{true, false}, true);
