...
//    /**
//     * This returned iterator is traversed only for its side effect.
//     * It's a lame imitation of a coprocess.
//     */
//    public Iterator<Void> loadStandardIterator(final Class<?> caller) {
//
//        final LoaderConfiguration cfg = this.cfg;
//
...
//         */
//        final List<String> classnames = ImmutableList.of(
...
//
////        return Iterators.transform(classnames.iterator(), new Function<String, Void>() {
//
//        return new Iterator<Void>() {
//
//            private final List<ClassLoader> loaders = getClassLoaders(cfg, caller);
//            private boolean foundLoader = false;
//            private ClassLoader cl = null;
//            private int loadedClasses = 0;
//            private Iterator<String> classIterator = classnames.iterator();
//
//            @Override
//            public boolean hasNext() {
//                boolean hasNext = classIterator.hasNext();
//                if (!hasNext) {
