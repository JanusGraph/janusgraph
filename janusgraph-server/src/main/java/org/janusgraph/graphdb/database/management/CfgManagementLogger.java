 ...
 */
public class CfgManagementLogger implements ManagementLogger {
    ...
    public CfgManagementLogger(StandardJanusGraph graph, Log sysLog, SchemaCache schemaCache, TimestampProvider times) {
        this.graph = graph;
    ...
    public void sendCacheEviction(Set<JanusGraphSchemaVertex> updatedTypes,
        ...
        this.sendCacheEviction(updatedTypes, false, updatedTypeTriggers, openInstances);
