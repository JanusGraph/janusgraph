...
public class TransportThriftElasticsearchTest extends ThriftElasticsearchTest {

    @Override
    public WriteConfiguration getConfiguration() {
        ModifiableConfiguration config =
                getCassandraThriftConfiguration(TransportThriftElasticsearchTest.class.getName());
        //Add index
